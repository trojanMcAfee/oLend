...
import {ERC20} from "../oztokens/ERC20.sol";
...
contract ozTokenDebt is ERC20 {
  ...
  function increaseAllowance(address, uint256) external override returns (bool) {
    revert OZError08();
  }

  function decreaseAllowance(address, uint256) external override returns (bool) {
    revert OZError08();
  }
